# IUS spec file for php72u, forked from
#
...
Provides: %{name}(api) = %{apiver}-%{__isa_bits}
Provides: %{name}(zend-abi) = %{zendver}-%{__isa_bits}
...
Conflicts: php56u-common, php70u-common, php71u-common
...
Provides: php(pdo-abi) = %{pdover}-%{__isa_bits}
Provides: %{name}-pdo-abi  = %{pdover}-%{__isa_bits}
Provides: %{name}(pdo-abi) = %{pdover}-%{__isa_bits}
...
%changelog
* Thu Oct  1 2020 Jeff Sheltren <jeff@tag1consulting.com> - 7.2.34-1
- Latest upstream

* Thu Aug  6 2020 Jeff Sheltren <jeff@tag1consulting.com> - 7.2.33-1
- Latest upstream
...
* Sun May 17 2020 Carl George <carl@george.computer> - 7.2.31-1
- Latest upstream

* Sat Apr 18 2020 Carl George <carl@george.computer> - 7.2.30-1
- Latest upstream
...
* Thu Dec 19 2019 Carl George <carl@george.computer> - 7.2.26-1
- Latest upstream

* Wed Nov 27 2019 Carl George <carl@george.computer> - 7.2.25-1
- Latest upstream
...
* Fri Aug 30 2019 Carl George <carl@george.computer> - 7.2.22-1
- Latest upstream
...
* Thu May 30 2019 Andrew Voss <andrew@voss.codes> - 7.2.19-1
- Latest upstream

* Thu May 02 2019 Carl George <carl@george.computer> - 7.2.18-1
- Latest upstream
...
* Fri Jan 11 2019 Carl George <carl@george.computer> - 7.2.14-1.ius
- Latest upstream
...
* Fri Mar 30 2018 Carl George <carl@george.computer> - 7.2.4-1.ius
- Latest upstream
